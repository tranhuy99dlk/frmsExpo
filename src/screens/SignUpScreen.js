    ...
    <View style={styles.container}>
      ...
      >
        {(props) => (
          <View style={styles.view2}>
            <View>
              <Text style={styles.text2}>Tạo tài khoản FRMS mới ?</Text>
            </View>
            ...
            <View style={styles.view15}>
              ...
              <View style={styles.view16}>
                <Text style={styles.text3}>đồng ý với của chúng tôi </Text>
      ...
      <View style={styles.view19}>
        <View style={styles.view20}>
          <Text style={styles.text6}>Đã có tài khoản FRMS? </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  input4: { fontSize: 16, marginLeft: -25, marginBottom: -10, paddingTop: 10 },
  ...
  view21: { marginTop: 5, alignItems: "flex-end", margin: 50 },
